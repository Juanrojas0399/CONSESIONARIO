...
#from apps.order.models import Work_order, Quotation, Bill, Order_detail, Quotation_detail, Bill_detail
from apps.order.models import Work_order, Order_detail
from apps.inventory.models import Article, Car, Replacement
from apps.login.models import Employee,Customer
