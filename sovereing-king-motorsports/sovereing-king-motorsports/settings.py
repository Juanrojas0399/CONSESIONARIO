"""
Django settings for sovereing-king-motorsports project.
...
ROOT_URLCONF = 'sovereing-king-motorsports.urls'
...
WSGI_APPLICATION = 'sovereing-king-motorsports.wsgi.application'
